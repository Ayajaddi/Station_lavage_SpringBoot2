...
<head>
  ...
  <title>Eco&EasyClean | Add Agency</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     <div class="container-fluid">
        <!-- SELECT2 EXAMPLE -->
        <form action="ServletAddAgency" method="post">
        <div class="card card-default">
           <div class="card-header">
            <h3 class="card-title">Saisissez le nom de l'agence/compagnie</h3>         
           </div>
          <!-- /.card-header -->
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Compagnie/Agence</label>
                    <input type="text" class="form-control" placeholder="Entrer Agence" name="nomAgence">
                </div>
                </div>
              </div>
